...
class GatewayDetail extends Component {
    static navigationOptions = ({ navigation }) => ({
        ...
        //     title={I18n.t('detail.history_data')}
    ...
    submit() {
        if (this.state.plateNo == '') {
            Alert.alert('', I18n.t('please_entry_plateNo'),
                [{
                    text: I18n.t('okText'),
                    onPress: () => { }
                }
                ...
                <ScrollView style={styles.container} bounces={false} >
                    ...
                    <View style={styles.itemView}>
                        ...
                        <View style={styles.itemRightView}>
                            ...
                            />
                            <TouchableOpacity activeOpacity={0.6} onPress={() => this.scanGatewaySn(1)} >
                    ...
                    <View style={styles.itemView}>
                        ...
                        <View style={styles.itemRightView}>
                            ...
                            />
                            <TouchableOpacity activeOpacity={0.6} onPress={() => this.scanGatewaySn(2)} >
                                <View style={styles.itemImageView}>
                                    <Image style={styles.itemImage} source={Images.other_scan} />
                                </View>
                            </TouchableOpacity>
